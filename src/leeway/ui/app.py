...
from leeway.ui.backend_host import run_backend_host
from leeway.ui.react_launcher import launch_react_tui
from leeway.ui.runtime import build_runtime, close_runtime, handle_line, start_runtime
...
async def run_repl(
    *,
    ...
    """Run the default Leeway interactive application (React TUI)."""
    if backend_only:
