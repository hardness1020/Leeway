...
from leeway.ui.protocol import BackendEvent, FrontendRequest, TranscriptItem
from leeway.ui.runtime import build_runtime, close_runtime, get_command_names, handle_line, start_runtime
...
class ReactBackendHost:
    """Drive the Leeway runtime over a structured stdin/stdout protocol."""
