...
app = typer.Typer(
    name="leeway",
    help=(
        "Leeway - A workflow-driven AI agent.\n\n"
...
def main(
    ...
    from leeway.ui.app import run_print_mode, run_repl
...
def scheduler_start() -> None:
    ...
    from leeway.cron.daemon import start_scheduler
...
def scheduler_stop() -> None:
    ...
    from leeway.cron.daemon import stop_scheduler
...
def scheduler_status() -> None:
    ...
    from leeway.cron.daemon import scheduler_status as _status
