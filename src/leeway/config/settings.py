"""Settings model and loading logic for Leeway.
...
3. Config file (~/.leeway/settings.json)
4. Defaults
"""
...
class Settings(BaseModel):
    """Main settings model for Leeway."""
...
def load_settings(config_path: Path | None = None) -> Settings:
    ...
    if config_path is None:
        from leeway.config.paths import get_config_file_path
