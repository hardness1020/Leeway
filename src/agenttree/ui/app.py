...
from agenttree.ui.backend_host import run_backend_host
from agenttree.ui.react_launcher import launch_react_tui
from agenttree.ui.runtime import build_runtime, close_runtime, handle_line, start_runtime
...
async def run_repl(
    *,
    ...
    """Run the default AgentTree interactive application (React TUI)."""
    if backend_only:
