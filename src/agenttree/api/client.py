...
from agenttree.api.errors import (
    AgentTreeApiError,
    AuthenticationFailure,
    RateLimitFailure,
    RequestFailure,
)
from agenttree.api.usage import UsageSnapshot
from agenttree.engine.messages import ConversationMessage, assistant_message_from_api
...
def _translate_api_error(exc: APIError) -> AgentTreeApiError:
