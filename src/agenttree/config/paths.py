"""Path resolution for AgentTree configuration and data directories.

Follows XDG-like conventions with ~/.agenttree/ as the default base directory.
"""
...
def get_config_file_path() -> Path:
    """Return the path to the main settings file (~/.agenttree/settings.json)."""
...
def get_project_config_dir(cwd: str | Path) -> Path:
    """Return the per-project .agenttree directory."""
    project_dir = Path(cwd).resolve() / ".agenttree"
